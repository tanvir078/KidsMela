...
export default function LoginPage() {
    ...
    const submit = (e) => {
        e.preventDefault();
        const newErrors = {};
        if (!form.phone.trim()) newErrors.phone = 'ফোন নম্বর বা ইমেইল দিন';
        ...
        setErrors({});
        addToast('লগইন সফল হয়েছে!', 'success');
        setTimeout(() => {
        ...
        <MobileShell title="Login" showSearch={false}>
            ...
            <section className="min-h-[80vh] px-4 py-6">
                ...
                <div className="mb-8 text-center">
                    ...
                    <h1 className="mt-4 text-2xl font-black text-slate-950">স্বাগতম!</h1>
                    <p className="mt-1 text-sm font-semibold text-slate-500">আপনার একাউন্টে লগইন করুন</p>
                </div>
