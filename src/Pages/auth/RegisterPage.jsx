        ...
        <MobileShell title="Register" showSearch={false} simpleHeader={true}>
            ...
            <section className="min-h-[80vh] px-4 py-6">
                <div className="mb-6 text-center">
                    ...
                    <p className="mt-1 text-sm font-semibold text-slate-500">Start shopping on Kids Mela</p>
                </div>
                ...
                <div className="space-y-3">
                    <button
                        type="button"
                        onClick={() => window.location.href = `${import.meta.env.VITE_API_BASE_URL || 'http://127.0.0.1:8000/api'}/auth/google`}
                    ...
                    <button
                        type="button"
                        onClick={() => window.location.href = `${import.meta.env.VITE_API_BASE_URL || 'http://127.0.0.1:8000/api'}/auth/facebook`}
