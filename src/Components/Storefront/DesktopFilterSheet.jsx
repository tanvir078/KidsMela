...
export default function DesktopFilterSheet({ isOpen, onClose, filters, onFilterChange, onApply, onReset }) {
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed right-0 top-0 z-50 h-screen w-[420px] bg-white shadow-2xl"
                    >
                        {/* Header */}
                        ...
                        <div className="h-[calc(100vh-180px)] overflow-y-auto px-6 py-6">
                            ...
                            {categories && categories.length > 0 && (
                                <div className="mb-8">
                                    <h3 className="mb-4 text-sm font-bold text-slate-900 uppercase tracking-wider">Categories</h3>
                            ...
                            {priceRange && (
                                <div className="mb-8">
                                    <h3 className="mb-4 text-sm font-bold text-slate-900 uppercase tracking-wider">Price</h3>
                            ...
                            {colors && colors.length > 0 && (
                                <div className="mb-8">
                                    <h3 className="mb-4 text-sm font-bold text-slate-900 uppercase tracking-wider">Color</h3>
                            ...
                            {tags && tags.length > 0 && (
                                <div className="mb-8">
                                    <h3 className="mb-4 text-sm font-bold text-slate-900 uppercase tracking-wider">Tags</h3>
                            ...
                            {brands && brands.length > 0 && (
                                <div className="mb-8">
                                    <h3 className="mb-4 text-sm font-bold text-slate-900 uppercase tracking-wider">Brand</h3>
                                    <div className="flex flex-wrap gap-2">
                                        {brands.map((brand) => (
                                            <button
                                                key={brand}
